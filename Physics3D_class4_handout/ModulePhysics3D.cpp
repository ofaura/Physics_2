...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btPoint2PointConstraint*>* c_item = constraint_list.getFirst();
	while (c_item)
	{
		delete c_item->data;
		c_item = c_item->next;
...
{
	btPoint2PointConstraint *constraint = new btPoint2PointConstraint(*bodyA.body, *bodyB.body, btVector3(anchorA.x, anchorA.y, anchorA.z), btVector3(anchorB.x, anchorB.y, anchorB.z));
